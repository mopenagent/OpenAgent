//! Slack channel — Slack Web API + Socket Mode.
//!
...
/// Build a Slack channel.
pub fn build(cfg: &SlackConfig) -> SlackChannel {
    ...
    SlackChannel::new(cfg.bot_token.clone(), app_token, channel_id, cfg.channel_ids.clone(), cfg.allowed_users.clone())
}
