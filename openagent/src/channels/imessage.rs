//! iMessage channel — macOS AppleScript bridge.
//!
...
/// Build an iMessage channel.
pub fn build(cfg: &IMessageConfig) -> IMessageChannel {
    IMessageChannel::new(cfg.allowed_contacts.clone())
}
