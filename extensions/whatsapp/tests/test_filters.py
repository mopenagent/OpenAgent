...
def test_direct_messages_are_allowed():
    message = OpenAgentMessage(chat_id="1555@s.whatsapp.net", body="hello", chat_type="direct")
...
def test_group_requires_mention_by_default():
    message = OpenAgentMessage(chat_id="1-2@g.us", body="hello team", chat_type="group")
